        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-10">
                    ...
                    <hr>
                     @if (Auth::check())
                    <p>{{ Auth::user()->name }} Ton code a fait crashé les internets, tu vas devoir y passer ton weekend.</br>
                    ...
                    <a href="{{ url('/home') }}" class="button_home">Return exercice</a>
                    ...
                    <a href="{{ url('/') }}" class="button_home">Return home</a>
