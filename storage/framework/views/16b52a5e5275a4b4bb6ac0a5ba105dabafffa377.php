    ...
    <div id="app">
        <nav class="navbar">
                <div class="navbar-header">
                    ...
                    <ul class="log_name">
                        <li class="user_name">
                            <a href="#" aria-expanded="false"> <?php echo e(Auth::user()->name); ?></a>
                            <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();document.getElementById('logout-form').submit();"><img src="img/delete.png" alt="logout"/></a>
